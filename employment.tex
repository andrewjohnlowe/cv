...
%\firstcolumndata{present}& {\it \htmladdnormallink{London Stock Exchange Group, UK}{https://www.lseg.com/} (xxxx--present)}\\
...
% which, in turn, was acquired by London Stock Exchange Group in XXXX-2020.
& \\
...
%& \\
%& Developed a cloud-hosted chatbot, using NLP platforms Rasa and IBM Watson Conversation, to process customer service requests for UBS, a major investment bank. Built ETL processes using KNIME for automated report generation for Bayer, a multinational pharmaceutical and life sciences company. Performed time series analysis and forecasting in R using retail data.\\
& \\
