...
\definecolor{skype}{RGB}{18,165,244}% black
\definecolor{linkedin}{RGB}{0,119,181}% light blue
\definecolor{github}{rgb}{0.45,0.45,0.45}% dark grey
...
\renewcommand*{\githubsocialsymbol}  {%
  \protect\raisebox{-0.15em}{%
    ...
    ( 96, 39) .. controls (108, 39) and (117, 48) ..
    (117, 60) -- cycle;
    \protect\path[fill=black, nonzero rule]
